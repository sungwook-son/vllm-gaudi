...
- `-s <scale_method>`: Selects the quantization scale method (default: `maxabs_hw`). Allowed values:
`unit_scale`, `maxabs_hw`, `maxabs_pow2`, `maxabs_hw_opt_weight`, `act_maxabs_pow2_weights_pcs_opt_pow2`, `act_maxabs_hw_weights_pcs_maxabs_pow2`, `act_maxabs_pcs_pow2_weight_maxabs_pts_pow2_hw`
